            ...
            <div id="login-form" class="container-fluid">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div id="login-control">
                        <input id="email" type="email" class="form-control-fluid form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Correo Electrónico" autofocus>
                        @error('email')
                    ...
                    <div id="login-control">
                        ...
                        @error('password')
                        <span class="invalid-feedback" style="padding: 2px;">
                            <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:" style="color:#e64545">
                                <use xlink:href="#exclamation-triangle-fill" />
                            </svg>
                            <strong style="color:#ed9f9f">{{ $message }}</strong>
                        </span>
